...
import Accordion from './secondAccordion';
                ...
                <div className="bg-gray-800 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      >
                        <div className="pr-4 ">
                          <DocumentMagnifyingGlassIcon className="w-10 border-2 border-gray-500 p-2 text-white rounded-md" />
                        </div>
                        <div className="flex">
                          <div>
                            <p className="font-semibold text-xl text-white">
                              Property Search: Build Your 1st List
                            </p>
                            <p className="text-sm pb-2 text-gray-400">
                              Simple code sample showing how the Property Search
                              API works
                            </p>
                          </div>
                        </div>
